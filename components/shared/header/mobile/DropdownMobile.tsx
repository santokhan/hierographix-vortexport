...
export default function TogglerAndDDMobile() {
  ...
  return (
    <div className="relative">
      <button
        type="button"
        className="inline-flex items-center p-2 text-sm text-gray-800 dark:text-gray-100 rounded-lg lg:hidden hover:dark:text-white focusring-2 focus:ring-gray-200"
...
export function DropdownMobile(props: DDMProps) {
  return (
    props.dropdown && (
...
export function ToMobile(props: {
  name: string;
  url: string;
  handleDropdown: () => void;
}) {
