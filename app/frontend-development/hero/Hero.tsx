      ...
      <div className="max-w-screen-xl mx-auto">
        <div className="max-w-3xl mx-auto flex flex-col items-center space-y-8 py-12 lg:py-20">
          <div className="text-start lg:text-center space-y-2">
            ...
            <p className="text-gray-400 text-start lg:text-center lg:text-lg">
...
export function HeroImage() {
  return <svg className="w-full" viewBox="0 0 800 464" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M192.633 225.479V293.275C192.633 321.18 215.254 343.801 243.159 343.801H294.302C317.973 343.801 337.163 324.612 337.163 300.94V300.94C337.163 277.268 356.353 258.078 380.025 258.078H442.381" stroke="url(#paint0_linear_2223_9654)" strokeWidth="4.21053" />
    <path d="M192.633 225.479V293.275C192.633 321.18 215.254 343.801 243.159 343.801H294.302C317.973 343.801 337.163 324.612 337.163 300.94V300.94C337.163 277.268 356.353 258.078 380.025 258.078H442.381" stroke="url(#paint1_linear_2223_9654)" strokeWidth="4.21053" />
    ...
    <rect x="253.936" y="82.8398" width="72.7443" height="11.0349" fill="white" fillOpacity="0.38" />
    ...
    <circle cx="110.543" cy="133.843" r="41.3495" fill="white" fillOpacity="0.14" />
    <circle cx="110.542" cy="133.843" r="29.4737" fill="white" fillOpacity="0.14" />
